...
#Reactive axonal sprouting - local and constrained to lesion

reconnected_nodes = sample(affected_nodes, round(0.5*len(affected_nodes)))
...
for node in reconnected_nodes:
    ...
    while not reconnected:
        ...
        if distance_matrix[node][random_node] < nx.average_shortest_path_length(G):
